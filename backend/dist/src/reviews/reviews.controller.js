...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Оставить отзыв (только CLIENT, только COMPLETED)' }),
...
__decorate([
    (0, common_1.Get)('businesses/:businessId/reviews'),
    (0, swagger_1.ApiOperation)({ summary: 'Отзывы бизнеса (публично)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Удалить отзыв (SUPER_ADMIN)' }),
