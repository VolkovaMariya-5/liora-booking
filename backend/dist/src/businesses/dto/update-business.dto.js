...
__decorate([
    (0, swagger_2.ApiPropertyOptional)({ example: 30, description: 'На сколько дней вперёд можно записаться' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
    (0, class_validator_1.Max)(90),
    __metadata("design:type", Number)
], UpdateBusinessDto.prototype, "maxAdvanceBookingDays", void 0);
