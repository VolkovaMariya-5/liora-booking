...
async function main() {
  ...
  const belleSalon = await prisma.business.create({
    data: {
      ...
      country: 'KZ',
      city: 'Усть-Каменогорск',
      logoUrl: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=400&q=80',
      isActive: true,
      isVisible: true,
  ...
  const glowNail = await prisma.business.create({
    data: {
      ...
      country: 'KZ',
      city: 'Усть-Каменогорск',
      logoUrl: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?w=400&q=80',
      isActive: true,
      isVisible: true,
